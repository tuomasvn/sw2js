...
// add your code here
let dialogue = document.querySelector('dialog').querySelector('img');
...
for (let i = 0; i < picArray.length; i++){
	...
	let image = picArray[i].image;
	let ilarge = image.large;
	let imedium = image.medium;

	let article = document.createElement('article');

	let arth2 = document.createElement('h2');
	arth2.appendChild(document.createTextNode(title));
	article.appendChild(arth2);

	let artfig = document.createElement('figure');
	let artfigimg = document.createElement('img');
	artfigimg.src = imedium;
	artfigimg.alt = title;
	let figcap = document.createElement('figcaption');
	figcap.appendChild(document.createTextNode(caption));
	artfig.appendChild(artfigimg);
	artfig.appendChild(figcap);
	article.appendChild(artfig);

	let artp = document.createElement('p');
	artp.appendChild(document.createTextNode(description));
...
document.querySelector('dialog span').addEventListener('click', B);